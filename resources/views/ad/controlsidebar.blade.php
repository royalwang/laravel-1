...
<aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-home-tab">
            <h3 class="control-sidebar-heading">日期选择</h3>
            <ul class='control-sidebar-menu'>
                <li>
                    <label>从</label><input name="date-start" style="width:80px" type="text">
                    <label>到</label><input name="date-end" style="width:80px" type="text">
                </li>
