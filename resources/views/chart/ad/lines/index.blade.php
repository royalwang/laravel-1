...
<button class="btn btn-block btn-primary" id="make">生成表格</button>

</div>

<div class="col-md-10 connectedSortable">
	<div class="col-md-6 line-chart-bg">
        <div class="chart-add sort-highlight" style="text-align:center;line-height:200px;"><i style="cursor:pointer;" class="fa fa-plus fa-4x"></i></div>
	</div>
